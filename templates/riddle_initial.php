<body>
  ...
  <script type="text/javascript">
    $(function(){
        ...
        $("#one").typed({
            strings: [
              "LOADING...^3000 <br><br>THERE ARE THREE SIBLINGS BEFORE ME,<br>AND THREE SIBLINGS AFTER.<br>BUT ONLY THE SIXTH, THE FIFTH, AND I<br>SHALL HAVE THE ENIGMA.^5000<br><br>INPUT AUTHORIZATION PASSCODE TO CONTINUE:"
            ],
            typeSpeed: 5,
            callback: function(){
                $(".typed-cursor").hide();
